...
item_batch = Endpoint("gameItemsBatch", methods=(Methods.POST, ), flags=("authrequired", ))
...
offer_batch = Endpoint("gameOffersBatch", methods=(Methods.POST, ), flags=("authrequired", ))
...
user_item_batch = Endpoint("userGameItemsBatch/{0}", methods=(Methods.POST, ), flags=("authrequired", ))
