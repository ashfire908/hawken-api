...
offer_redeemer = Endpoint("userGameOfferRedeemer/{0}/{1}", methods=(Methods.POST, ))
offer_renter = Endpoint("userGameOfferRenter/{0}/{1}", methods=(Methods.POST, ))
...
user_item = Endpoint("userGameItems/{0}", methods=(Methods.GET, ))
user_item_batch = Endpoint("userGameItemsBatch/{0}", methods=(Methods.POST, ))
user_item_broker = Endpoint("userGameItemsBroker/{0}/{1}", methods=(Methods.PUT, ))
user_item_stat = Endpoint("userGameItemStats/{0}", methods=(Methods.GET, ))
user_item_stat_single = Endpoint("userGameItemStats/{0}/{1}", methods=(Methods.GET, ))
user_meteor_batch = Endpoint("userMeteorSettings", methods=(Methods.GET, ))
user_meteor_single = Endpoint("userMeteorSettings/{0}", methods=(Methods.GET, ))
